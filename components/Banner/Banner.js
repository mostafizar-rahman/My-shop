...
const Banner = () => {
  return (
    <section className=" grid lg:grid-cols-[auto_50%_20%] md:grid-cols-[auto_70%] grid-cols-1 md:gap-x-5 gap-x-0 ">
      <div className="lg:row-span-2 hidden md:block lg:h-[700px] h-[600px] relative">
        ...
        <div className="absolute top-0 left-0 z-10 bg-black bg-opacity-30 text-slate-100 p-3 w-full h-full flex items-centr">
          <h3 className="lg:text-3xl text-xl font-semibold text-slate-100 rotate-90 font-norican">
            Hooded
          </h3>
        </div>
      </div>
