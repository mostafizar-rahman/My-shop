        ...
        <div className=' px-5 py-10 h-full rounded-md relative w-[700px] '>
          ...
          <form className="space-y-6">
            <div className="space-y-1 text-sm">
              <label htmlFor="eamil" className="block">Name</label>
              <input type="text" name="name" placeholder="Name" className="w-full px-4 py-3 rounded-md border border-gray-300" />
            </div>
            <div className="space-y-1 text-sm">
          ...
          <div className="flex items-center justify-center pt-4 space-x-1 mt-7">
